...
const AboutUs = () => {
  ...
  return (
    <section
      ...
      className="py-12 px-6 lg:px-40 -scroll-mt-14"
      id="about-us"
    >
      <div className="relative flex flex-col lg:flex-row h-full border border-gray-400 rounded-xl">
        ...
        <div className="lg:w-1/2 h-full flex items-center justify-center p-8">
          <div className="max-w-md p-4 lg:p-20 text-center lg:text-start">
            <p
              className={`mb-6 text-lg text-[#8A8A8A] ${
            ...
            >
              Acompañamiento 360° en su adopción a la nube de{" "}
              <span className="font-bold text-[#8A8A8A]">Huawei</span>.
            </p>
            <p
            ...
            >
              Escuchamos tus necesidades, nos alineamos con sus objetivos y lo
              apoyamos para que los alcance.
            </p>
          </div>
        </div>
      </div>
